...
namespace CustomEmotesAPI_Template_Mod
{
    public static class Assets
    {
        ...
        public static void LoadAssetBundlesFromFolder(string folderName, bool check = false)
        {
            if(check) {
                ...
                folderName = Path.GetDirectoryName(ExampleEmoteMod.PInfo.Location);
            }
            ...
            foreach (var file in Directory.GetFiles(folderName))
            {
                ...
                {
                    // Skip loading asset bundle if file has no extension
                }
                else
                {
